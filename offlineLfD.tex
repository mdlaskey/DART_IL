...
However, the error also depends on the expected loss on the data collected during RC, which may be high due to observing complex recovery actions. \jmnote{Revisit} 
We analyze this effect and show how it can prevent RC from converging to the supervisor's policy. 
