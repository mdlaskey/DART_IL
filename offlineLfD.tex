...
In this section, we are interesting in analyzing passive LfD and adaptive LfD when the supervisor $\tilde{\pi}$ is realizable, or $\tilde{\pi} \in \Theta$, for all states within the support of $p(\tau|\tilde{\pi})$.
